...
npx skills add vukor/skills --skill opencode-permissions --global
npx skills add vukor/skills --skill opencode-session-finder --global
npx skills add vukor/skills --skill opencode-session-manager --global
